...
class DirectoryCopierApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("copyMan_v4")
        ...
        # 選択されたディレクトリ表示リスト
        self.selected_dirs_list = DroppableQListWidget(self)
        ...
        self.dest_dir_display.setAcceptDrops(False)  # ドロップを無効にする
        # self.dest_dir_display.dragEnterEvent = self.dragEnterEvent # 不要なので削除
        # self.dest_dir_display.dropEvent = self.dropEvent # 不要なので削除
